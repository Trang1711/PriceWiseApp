...
# Import routers
from routers import auth, password, product_platform, user_router, category, product_router, favorite, search_history_router, admin_product_platform, admin_product, platform, image_search
